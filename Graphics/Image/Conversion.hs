...
instance Convertable PixelYA8 where
  toGray (PixelYA8 g a) = Gray (fromWord8 g) * Gray (fromWord8 a)
  fromGray (Gray g) = PixelYA8 (toWord8 g) (toWord8 1)
  toColor = fromGray . toGray
  fromColor = fromGray . toGray

instance Convertable PixelYA16 where
  toGray (PixelYA16 g a) = Gray (fromWord16 g) * Gray (fromWord16 a)
  fromGray (Gray g) = PixelYA16 (toWord16 g) (toWord16 1)
  toColor = fromGray . toGray
  fromColor = fromGray . toGray
...
instance Convertable PixelRGBA8 where
  ...
  toColor (PixelRGBA8 r g b a) =
    RGB (fromWord8 r) (fromWord8 g) (fromWord8 b) * RGB a' a' a'
    where a' = (fromWord8 a)
  fromColor (RGB r g b) =
    PixelRGBA8 (toWord8 r) (toWord8 g) (toWord8 b) (toWord8 1)

instance Convertable PixelRGBA16 where
  toGray = toGray . toColor
  fromGray = fromColor . toColor
  toColor (PixelRGBA16 r g b a) =
    RGB (fromWord16 r) (fromWord16 g) (fromWord16 b) * RGB a' a' a'
    where a' = (fromWord16 a)
  fromColor (RGB r g b) =
    PixelRGBA16 (toWord16 r) (toWord16 g) (toWord16 b) (toWord16 1)

instance Convertable PixelYCbCr8 where
  toGray = toGray . toColor
  fromGray = fromColor . toColor
  toColor = toColor . (convertPixel :: PixelYCbCr8 -> PixelRGB8)
  fromColor = (convertPixel :: PixelRGB8 -> PixelYCbCr8) . fromColor 

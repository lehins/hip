...
instance Writable (Image VS Y Word8) BMP where
  encode _ _ = JP.encodeBitmap . imageToJPImage (Proxy :: Proxy JP.Pixel8) id

instance Writable (Image VS RGB Word8) BMP where
  encode _ _ = JP.encodeBitmap . imageToJPImage (Proxy :: Proxy JP.PixelRGB8) id

instance Writable (Image VS RGBA Word8) BMP where
  encode _ _ = JP.encodeBitmap . imageToJPImage (Proxy :: Proxy JP.PixelRGBA8) id

instance Writable (Image VS Binary Bit) BMP where
  encode _ _ = JP.encodeBitmap . imageToJPImage (Proxy :: Proxy JP.Pixel8) fromPixelBinary

instance Writable (Image VS Y Double) BMP where
  encode _ _ = JP.encodeBitmap . imageToJPImage (Proxy :: Proxy JP.Pixel8) (fmap toWord8)

instance Writable (Image VS YA Double) BMP where
  encode _ _ = JP.encodeBitmap . imageToJPImage (Proxy :: Proxy JP.Pixel8)
                                                ((fmap toWord8) . dropAlpha)

instance Writable (Image VS RGB Double) BMP where
  encode _ _ = JP.encodeBitmap . imageToJPImage (Proxy :: Proxy JP.PixelRGB8) (fmap toWord8)

instance Writable (Image VS RGBA Double) BMP where
  encode _ _ = JP.encodeBitmap . imageToJPImage (Proxy :: Proxy JP.PixelRGBA8) (fmap toWord8)
...
encodeGIF []                     !conv =
  ...
  JP.palettize JP.defaultPaletteOptions . imageToJPImage (Proxy :: Proxy JP.PixelRGB8) conv
encodeGIF (GIFPalette palOpts:_) !conv =
  either error id . uncurry JP.encodeGifImageWithPalette .
  JP.palettize palOpts . imageToJPImage (Proxy :: Proxy JP.PixelRGB8) conv
  ...
  either error id . JP.encodeGifImages (getGIFALoop opts) . P.map palletizeGif where
    ...
    palletizeGif !(d, img) = (p, d, jimg) where
      !(jimg, p) = JP.palettize (getGIFAPal opts) $
                   imageToJPImage (Proxy :: Proxy JP.PixelRGB8) conv img
...
instance Writable (Image VS RGB Float) HDR where
  encode _ _ = JP.encodeHDR . imageToJPImage (Proxy :: Proxy JP.PixelRGBF) id

instance Writable (Image VS Y Double) HDR where
  encode _ _ = JP.encodeHDR . imageToJPImage (Proxy :: Proxy JP.PixelRGBF)
...
instance Writable (Image VS RGB Double) HDR where
  encode _ _ = JP.encodeHDR . imageToJPImage (Proxy :: Proxy JP.PixelRGBF) (fmap toFloat)
...
instance Writable (Image VS Y Word8) JPG where
  encode _ opts = encodeJPG opts (Proxy :: Proxy JP.Pixel8) id

instance Writable (Image VS RGB Word8) JPG where
  encode _ opts = encodeJPG opts (Proxy :: Proxy JP.PixelRGB8) id

instance Writable (Image VS CMYK Word8) JPG where
  encode _ opts = encodeJPG opts (Proxy :: Proxy JP.PixelCMYK8) id

instance Writable (Image VS YCbCr Word8) JPG where
  encode _ opts = encodeJPG opts (Proxy :: Proxy JP.PixelYCbCr8) id

instance Writable (Image VS Y Double) JPG where
  encode _ opts = encodeJPG opts (Proxy :: Proxy JP.Pixel8) (fmap toWord8)

instance Writable (Image VS YA Double) JPG where
  encode _ opts = encodeJPG opts (Proxy :: Proxy JP.Pixel8) ((fmap toWord8) . dropAlpha)

instance Writable (Image VS RGB Double) JPG where
  encode _ opts = encodeJPG opts (Proxy :: Proxy JP.PixelRGB8) (fmap toWord8)

instance Writable (Image VS RGBA Double) JPG where
  encode _ opts = encodeJPG opts (Proxy :: Proxy JP.PixelRGB8) ((fmap toWord8) . dropAlpha)


-- Writable PNG

instance Writable (Image VS Binary Bit) PNG where
  encode _ _ = JP.encodePng . imageToJPImage (Proxy :: Proxy JP.Pixel8) fromPixelBinary

instance Writable (Image VS Y Word8) PNG where
  encode _ _ = JP.encodePng . imageToJPImage (Proxy :: Proxy JP.Pixel8) id

instance Writable (Image VS Y Word16) PNG where
  encode _ _ = JP.encodePng . imageToJPImage (Proxy :: Proxy JP.Pixel16) id

instance Writable (Image VS YA Word8) PNG where
  encode _ _ = JP.encodePng . imageToJPImage (Proxy :: Proxy JP.PixelYA8) id

instance Writable (Image VS YA Word16) PNG where
  encode _ _ = JP.encodePng . imageToJPImage (Proxy :: Proxy JP.PixelYA16) id

instance Writable (Image VS RGB Word8) PNG where
  encode _ _ = JP.encodePng . imageToJPImage (Proxy :: Proxy JP.PixelRGB8) id

instance Writable (Image VS RGB Word16) PNG where
  encode _ _ = JP.encodePng . imageToJPImage (Proxy :: Proxy JP.PixelRGB16) id

instance Writable (Image VS RGBA Word8) PNG where
  encode _ _ = JP.encodePng . imageToJPImage (Proxy :: Proxy JP.PixelRGBA8) id

instance Writable (Image VS RGBA Word16) PNG where
  encode _ _ = JP.encodePng . imageToJPImage (Proxy :: Proxy JP.PixelRGBA16) id


instance Writable (Image VS Y Double) PNG where
  encode _ _ = JP.encodePng . imageToJPImage (Proxy :: Proxy JP.Pixel16) (fmap toWord16)

instance Writable (Image VS YA Double) PNG where
  encode _ _ = JP.encodePng . imageToJPImage (Proxy :: Proxy JP.PixelYA16) (fmap toWord16)

instance Writable (Image VS RGB Double) PNG where
  encode _ _ = JP.encodePng . imageToJPImage (Proxy :: Proxy JP.PixelRGB16) (fmap toWord16)

instance Writable (Image VS RGBA Double) PNG where
  encode _ _ = JP.encodePng . imageToJPImage (Proxy :: Proxy JP.PixelRGBA16) (fmap toWord16)

-- Writable TGA

instance Writable (Image VS Binary Bit) TGA where
  encode _ _ = JP.encodeTga . imageToJPImage (Proxy :: Proxy JP.Pixel8) fromPixelBinary

instance Writable (Image VS Y Word8) TGA where
  encode _ _ = JP.encodeTga . imageToJPImage (Proxy :: Proxy JP.Pixel8) id

instance Writable (Image VS RGB Word8) TGA where
  encode _ _ = JP.encodeTga . imageToJPImage (Proxy :: Proxy JP.PixelRGB8) id

instance Writable (Image VS RGBA Word8) TGA where
  encode _ _ = JP.encodeTga . imageToJPImage (Proxy :: Proxy JP.PixelRGBA8) id


instance Writable (Image VS Y Double) TGA where
  encode _ _ = JP.encodeTga . imageToJPImage (Proxy :: Proxy JP.Pixel8) (fmap toWord8)

instance Writable (Image VS YA Double) TGA where
  encode _ _ = JP.encodeTga . imageToJPImage (Proxy :: Proxy JP.Pixel8) ((fmap toWord8) . dropAlpha)

instance Writable (Image VS RGB Double) TGA where
  encode _ _ = JP.encodeTga . imageToJPImage (Proxy :: Proxy JP.PixelRGB8) (fmap toWord8)

instance Writable (Image VS RGBA Double) TGA where
  encode _ _ = JP.encodeTga . imageToJPImage (Proxy :: Proxy JP.PixelRGBA8) (fmap toWord8)

-- Writable TIF

instance Writable (Image VS Y Word8) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.Pixel8) id

instance Writable (Image VS Y Word16) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.Pixel16) id

instance Writable (Image VS YA Word8) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.PixelYA8) id

instance Writable (Image VS YA Word16) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.PixelYA16) id

instance Writable (Image VS RGB Word8) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.PixelRGB8) id

instance Writable (Image VS RGB Word16) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.PixelRGB16) id

instance Writable (Image VS RGBA Word8) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.PixelRGBA8) id

instance Writable (Image VS RGBA Word16) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.PixelRGBA16) id

instance Writable (Image VS YCbCr Word8) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.PixelYCbCr8) id

instance Writable (Image VS CMYK Word8) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.PixelCMYK8) id

instance Writable (Image VS CMYK Word16) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.PixelCMYK16) id


instance Writable (Image VS Binary Bit) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.Pixel8) fromPixelBinary

instance Writable (Image VS Y Double) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.Pixel16) (fmap toWord16)

instance Writable (Image VS YA Double) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.PixelYA16) (fmap toWord16)

instance Writable (Image VS RGB Double) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.PixelRGB16) (fmap toWord16)

instance Writable (Image VS RGBA Double) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.PixelRGBA16) (fmap toWord16)

instance Writable (Image VS YCbCr Double) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.PixelYCbCr8) (fmap toWord8)

instance Writable (Image VS CMYK Double) TIF where
  encode _ _ = JP.encodeTiff . imageToJPImage (Proxy :: Proxy JP.PixelCMYK16) (fmap toWord16)



imageToJPImage
  :: (JP.Pixel a, Array VS cs' e, Array VS cs (JP.PixelBaseComponent a))
  => Proxy a
  -> (Pixel cs' e -> Pixel cs (JP.PixelBaseComponent a))
  -> Image VS cs' e
  -> JP.Image a
